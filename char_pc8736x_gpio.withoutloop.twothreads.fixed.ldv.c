...
int ldv_thread_create(pthread_t *ldv_thread, void (*function)(void * ) , void *data);
int ldv_thread_join(pthread_t ldv_thread, void (*function)(void * ));
...
void default_release(struct inode * inode, struct file * filp) {
	...
	//pthread_join(pthread_t_pc8736x_gpio_ops2, NULL);
}
