...
static int bh1770_resume(struct device *dev )
{
  ...
  if (tmp___2) {
    ...
    bh1770_lux_update_thresholds(chip, 1000, 1000);
    chip->lux_wait_result = 1;
    chip_lux_wait_result = 1;
    ldv_assert("", chip_lux_wait_result == 1);
    bh1770_prox_mode_control(chip);
    }
  } else {
  }
...
void *ldv_insmod_8(void *arg0 )
{
  ...
  if (tmp___1 != 0) {
    ...
    {
    __VERIFIER_assume(ldv_8_ret_default == 0);
    ldv_8_reg_guard_9_default = ldv_undef_int();
    ldv_8_reg_guard_3_default = ldv_undef_int();
    ldv_8_reg_guard_7_default = ldv_undef_int();
    }
    if (ldv_8_reg_guard_9_default != 0) {
      {
      ldv_dispatch_default_register_9_8_7();
      }
    } else {
    }
    ...
    if (ldv_8_reg_guard_9_default != 0) {
      {
      ldv_dispatch_default_deregister_9_8_3();
      }
    } else {
    }
    {
