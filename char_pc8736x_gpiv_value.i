...
# 2 "char_pc8736x_gpio.c" 2
# 13 "char_pc8736x_gpio.c"
# 1 "./model/svcomp.h" 1
# 9 "./model/svcomp.h"
...
void pc8736x_gpio_set(unsigned minor, int val)
{
 ...
 mutex_lock(&pc8736x_gpio_config_lock);
 global_port = 2;
 __VERIFIER_assert(global_port == 2);
 mutex_unlock(&pc8736x_gpio_config_lock);
}
...
int pc8736x_gpio_current(unsigned minor)
{
 ...
 mutex_lock(&pc8736x_gpio_config_lock);
        u8 tmp = global_port;
        __VERIFIER_assert(tmp == global_port);
        mutex_unlock(&pc8736x_gpio_config_lock);
 return ((tmp >> bit) & 0x01);
}
...
int main(void)
{
 ...
 pthread_create(&pthread_t_pc8736x_gpio_open, ((void *)0), pc8736x_gpio_current, ((void *)0));
 pthread_create(&pthread_t_pc8736x_gpio_change, ((void *)0), whoop_wrapper_pc8736x_gpio_set, ((void *)0));
